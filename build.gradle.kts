...
intellijPlatform {
    pluginConfiguration {
        ...
        changeNotes = """
         <h1 id="section">0.1.0</h1>
         <p>We finally bumped to the first minor version since we are now
         reasonable confident of the stability. ## Fixes - Disable usage of soon
         to deprecated LSP flag (really this time)</p>
         <h2 id="requirements">Requirements</h2>
         <ul>
         <li>This plugin works only on IntelliJ &gt;= 2025.2.1</li>
         <li>Local installation of the openvadl compiler</li>
         </ul>
         <h1 id="section-1">0.0.9</h1>
         ...
         <h1 id="section-7">0.0.2</h1>
         <h2 id="new-features-5">New Features</h2>
         <ul>
         <li>Windows support</li>
         <li>Icons</li>
         </ul>
         <h2 id="requirements-7">Requirements</h2>
         <ul>
         <li>This plugin works only on IntelliJ &gt;= 2025.3</li>
